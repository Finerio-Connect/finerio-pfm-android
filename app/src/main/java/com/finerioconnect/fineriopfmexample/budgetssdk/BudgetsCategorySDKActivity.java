...
import com.finerioconnect.fineriopfmexample.databinding.ActivityBudgetsCategorySdkBinding;
...
public class BudgetsCategorySDKActivity extends AppCompatActivity {
    private ActivityBudgetsCategorySdkBinding binding;
    private static final String CATEGORY_KEY = "categoryKey";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityBudgetsCategorySdkBinding.inflate(getLayoutInflater());
    ...
    private void setUp() {
        ...
        binding.categoryView.setUpView(categories, FCCategoryType.SHOW_ALL_ONLY_ONE_CATEGORY, null);
        binding.categoryView.setListener((OnFCCategoryListener) this::goToCreateBudget);
    }

    private void goToCreateBudget(FCCategory category) {
        if (category != null) {
